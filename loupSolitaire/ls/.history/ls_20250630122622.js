...
setTimeout(() => {
  if (btn2) {
    btn2.onclick = () => {
      ...
      afficherBarres(2, "(Psychique)", habHeroMax, vieHeroMax, vieHeroMax, vieHeroMax);
    };
  }
  ...
  if (btn0) {
    btn0.onclick = () => {
      ...
      if (confirmationDiv) confirmationDiv.remove();
      div.querySelector("#zoneBarresCombat").style.display = "";
      afficherBarres(0, "", habHeroMax, vieHeroMax, vieHeroMax, vieHeroMax);
    };
  }
}, 50);
  ...
  afficherBarres(0, "", habHeroMax, vieHeroMax, vieHeroMax, vieHeroMax);
    ...
    function afficherBarres(bonusPsy, messagePsy, habHeroMax, vieHeroMax, vieHeroMax, vieHeroMax, vieHeroMaxCombat) {
  ...
  const vieHeroMaxCombat = vieHero;
  const vieHeroMax = vieHeroMaxCombat;  // valeur à passer en paramètre
  ...
  div.querySelector("#btnMonstreMoins2").onclick = function () {
    ...
    if (armesPsy || bouclierPsy) {
      if (armesPsy && bouclierPsy) {
        div.querySelector("#btnPsy4").onclick = () => afficherBarres(4, "(Arme + Bouclier Psychique)", habHeroMax, vieHeroMax);
        div.querySelector("#btnPsy2").onclick = () => afficherBarres(2, "(Arme ou Bouclier Psychique)", habHeroMax, vieHeroMax);
        div.querySelector("#btnPsy0").onclick = () => afficherBarres(0, "", habHeroMax, vieHeroMax,ieHeroMax);
      } else {
        div.querySelector("#btnPsy2").onclick = () => afficherBarres(2, "(Psychique)", habHeroMax, vieHeroMax, vieHeroMax);
        div.querySelector("#btnPsy0").onclick = () => afficherBarres(0, "", habHeroMax, vieHeroMax, vieHeroMax);
      }
    } else {
