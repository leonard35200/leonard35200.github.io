...
// Choix ou récupération de l'arme maîtrisée
...
const disciplinesKai = [
  ...
  // Remplacement du nom par l'arme tirée au sort
  { nom: `Maîtrise des armes (+2 si possède ${armeMaitrisee})`, effet: "+2 HABILETÉ avec arme tirée au sort." },
