...
console.log("confirmationDiv trouvé ?", confirmationDiv);
console.log("🧪 armesPsy =", armesPsy);
...
console.log("🧩 btn0 =", btn0);
  ...
  btn2.onclick = function () {
    console.log("✅ le bouton +2 a bien été cliqué");
  };
  console.log("➡️ btn2.disabled =", btn2.disabled);
  console.log("➡️ btn2 visible ?", btn2.offsetParent !== null);
}
