...
# Initialisation des fichiers si nécessaire
def init_files():
...
def index():
    # Lecture du numéro de paragraphe courant
    ...
    if request.method == "POST":
        ...
        if texte:
            # Insertion du nouveau paragraphe dans le fichier HTML
...
function applyHighlight() {{
  ...
  document.getElementById("preview").innerHTML = '<p>' + highlighted + '</p>';
}}
...
3. Sélectionnez le texte à mettre en gras et cliquez “Mettre en gras”.
