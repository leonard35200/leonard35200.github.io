...
<body><h1>Loup Solitaire - Paragraphe 1</h1><p style="display: none;">écrire avant ici</p></body></html>
""")
...
def index():
    ...
    if request.method == "POST":
        ...
        vulnerablePsy = request.form.get("vulnerablePsy", "").strip()
        attaquePsy = request.form.get("attaquePsy", "").strip()
        attaqueQuotient = request.form.get("attaqueQuotient", "").strip()
        ...
        if texte:
            with open(HTML_FILE, "r+", encoding="utf-8") as f:
                ...
                # Construire les attributs data si au moins un est présent
                data_attrs = ""
                if vulnerablePsy or attaquePsy or attaqueQuotient or bonus:
                    data_attrs = (
...
<form id="form" method="post" style="display:none;">
  ...
  <!-- Ajout des inputs cachés pour les data attributes -->
  <input type="hidden" name="vulnerablePsy" id="vulnerablePsy">
  <input type="hidden" name="attaquePsy" id="attaquePsy">
  <input type="hidden" name="attaqueQuotient" id="attaqueQuotient">
...
function submitText() {
  ...
  // Pour l'exemple, on fixe arbitrairement les data (à adapter)
  document.getElementById("vulnerablePsy").value = "True";
  document.getElementById("attaquePsy").value = "False";
  document.getElementById("attaqueQuotient").value = "0hab";
  document.getElementById("bonus").value = "0hab";
