...
setTimeout(() => {
  ...
  afficherBarres(0, "", habHeroMax);
    ...
    function afficherBarres(bonusPsy, messagePsy, habHeroMax, vieHeroMaxCombat) {
  ...
  div.querySelector("#btnMonstreMoins2").onclick = function () {
    ...
    if (armesPsy || bouclierPsy) {
      if (armesPsy && bouclierPsy) {
        div.querySelector("#btnPsy4").onclick = () => afficherBarres(4, "(Arme + Bouclier Psychique)", habHeroMax);
        div.querySelector("#btnPsy2").onclick = () => afficherBarres(2, "(Arme ou Bouclier Psychique)", habHeroMax);
