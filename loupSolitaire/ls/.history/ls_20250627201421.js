...
class NavigationManager {
  ...
  div.innerHTML = '<div style="background:#222;color:#fff;border:2px solid #c00;padding:1em;margin-top:1em;text-align:center;font-size:2em;border-radius:12px;box-shadow:0 4px 16px #000a;">COMBAT</div>';
