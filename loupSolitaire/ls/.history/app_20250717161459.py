...
function wrapSelectedText() {
  ...
  // Saut de lignes autour (comme avant)
  ...
  const val1 = prompt("Valeur pour data-vulnerablePsy ?", "True");
  const val2 = prompt("Valeur pour data-attaquePsy ?", "False");
  const val3 = prompt("Valeur pour data-attaqueQuotient ?", "0hab");
  const val4 = prompt("Valeur pour data-bonus ?", "0hab");

  // Ajouter les attributs au <p> parent
