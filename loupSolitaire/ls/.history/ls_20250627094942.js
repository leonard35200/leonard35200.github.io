...
// ======================
// À placer en tête de votre fichier ls.js
const CONFIG = {
  ...
  get test() {
    ...
    try {
      ...
      console.warn("Impossible de parser disciplines_choisies :", e);
      saved = [];
    }
    // Si aucune discipline n'est enregistrée, on démarre en mode interactif (1)
    // Sinon, on affiche en mode statique (0)
    return saved.length === 0 ? 1 : 0;
  }
};

// Exemple d'utilisation dans votre code :
console.log("Mode courant :", CONFIG.test === 1 ? "interactif" : "statique");
