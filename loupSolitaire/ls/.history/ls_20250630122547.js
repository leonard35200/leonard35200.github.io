...
setTimeout(() => {
  ...
  afficherBarres(0, "", habHeroMax, vieHeroMax);
    ...
    function afficherBarres(bonusPsy, messagePsy, habHeroMax, vieHeroMax, vieHeroMaxCombat) {
  ...
  div.querySelector("#btnMonstreMoins2").onclick = function () {
    ...
    if (armesPsy || bouclierPsy) {
      if (armesPsy && bouclierPsy) {
        ...
        div.querySelector("#btnPsy2").onclick = () => afficherBarres(2, "(Psychique)", habHeroMax);
        div.querySelector("#btnPsy0").onclick = () => afficherBarres(0, "", habHeroMax);
      }
    } else {
