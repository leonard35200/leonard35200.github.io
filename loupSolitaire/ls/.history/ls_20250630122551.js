...
setTimeout(() => {
  ...
  afficherBarres(0, "", habHeroMax, vieHeroMax, vieHeroMax, vieHeroMax);
    ...
    function afficherBarres(bonusPsy, messagePsy, habHeroMax, vieHeroMax, vieHeroMax, vieHeroMaxCombat) {
  ...
  div.querySelector("#btnMonstreMoins2").onclick = function () {
    ...
    if (armesPsy || bouclierPsy) {
      if (armesPsy && bouclierPsy) {
        div.querySelector("#btnPsy4").onclick = () => afficherBarres(4, "(Arme + Bouclier Psychique)", habHeroMax, vieHeroMax, vieHeroMax);
