...
setTimeout(() => {
  ...
  div.querySelector("#btnMonstreMoins2").onclick = function () {
    ...
    if (armesPsy || bouclierPsy) {
      if (armesPsy && bouclierPsy) {
        div.querySelector("#btnPsy4").onclick = () => afficherBarres(4, "(Arme + Bouclier Psychique)", habHeroMax, vieHeroMax, vieHeroMax, vieHeroMax);
        div.querySelector("#btnPsy2").onclick = () => afficherBarres(2, "(Arme ou Bouclier Psychique)", habHeroMax, vieHeroMax, vieHeroMax);
